...
4. Deliver a baseline that can run without external dependencies (static linking).
...
* Qt 6 is statically linked under GPL-3.
...
10. Packaging/build targets (CMake, static linking)
...
8. Static linking under GPL-3 for all Qt components.
...
* Qt 6 SDK (static build, GPL-3) or build from source
* CMake 3.20+
...
2. Configure build with static linking
