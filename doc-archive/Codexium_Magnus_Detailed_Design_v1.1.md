...
The detailed design defines the architecture, data models, and component interactions for Codexium Magnus v1.1. It captures the implementation model that follows the system architecture and the high-level design. This version adds support for multi-cartridge libraries via a manifest subsystem.
